...
public class FlickrImageSizes {
    public ImageSize squareSize = null;
    public ImageSize thumbnailSize = null;
    public ImageSize smallSize = null;
    public ImageSize mediumSize = null;
    public ImageSize largeSize = null;
    public ImageSize originalSize = null;

    public URL squareURL = null;
    public URL thumbnailURL = null;
    public URL smallURL = null;
    public URL mediumURL = null;
    public URL largeURL = null;
    public URL originalURL = null;

    public FlickrImageSizes() {
    }
