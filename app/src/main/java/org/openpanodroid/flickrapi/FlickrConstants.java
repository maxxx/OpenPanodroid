...
public class FlickrConstants {
    ...
    public static final String API_KEY_PANODROID = "245e349c3b2892cf59d303b4ce9c5b7f";
    public static final String FLICKR_URL = "http://api.flickr.com/services/rest";
    public static final String IMAGE_HOST = "static.flickr.com";
}
