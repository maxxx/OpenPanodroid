...
uint32_t getEquirectangularPixel(const void *pixels, int width, int height, int stride,
...
void cubeToSphericalCoordinates1(const CubeCoordinates *cubeCoordinates, int face,
...
void cubeToSphericalCoordinates2(const CubeCoordinates *cubeCoordinates, int face,
                                 SphericalCoordinates *sphericalCoordinates) {
...
void cubeToSphericalCoordinates(const CubeCoordinates *cubeCoordinates, int face,
                                SphericalCoordinates *sphericalCoordinates) {
...
JNIEXPORT void JNICALL Java_org_openpanodroid_panoutils_android_CubicPanoNative_calculateCubeSide(JNIEnv *env,
                                                                                                  jclass obj,
                                                                                                  jobject panoBmp,
                                                                                                  jobject faceBmp,
                                                                                                  jint face) {
    ...
    for (int xTexture = 0; xTexture < faceBmpInfo.width; xTexture++) {
        ...
        for (int yTexture = 0; yTexture < faceBmpInfo.height; yTexture++) {
            ...
            uint32_t pixel = getEquirectangularPixel(panoPixels, panoBmpInfo.width, panoBmpInfo.height,
                                                     panoBmpInfo.stride, &sphericalCoordinates);
